...
* Inteligência Artificial Explicável (XAI, do inglês _Explainable Artificial Intelligence_) é aplicação da explicabilidade, como a explicação das saídas do sistema, focada para a área de inteligência artificial (página 2).
